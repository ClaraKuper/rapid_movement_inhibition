...
jsPsych.plugins["canvas-mi-serial"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        let response_on = 'touchstart';//'mousedown';//
        let response_off = 'touchend';//'mouseup';//
        ...
        let perform_updates = function (shift, circles, color, rect, photodiode_square, photodiode_color) {
        ...
        let get_current_position_and_color = function (timestamp){
            ...
            let color = [trial.circle_color, trial.flash_color][+(after_next_change && before_flash_off)];
            let photodiode_color = [trial.background_color, '#FFFFFF'][+(after_next_change && before_flash_off)]
            ...
            return [after_first_change, color, photodiode_color];
        };
        ...
        let animate = function (timestamp) {
            ...
            perform_updates(repaint_values[0], target_circles, repaint_values[1], rectangle,
                photodiode_check, repaint_values[2]);
